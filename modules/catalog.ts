...
export const MODULE_CATALOG: ModuleCatalogEntry[] = [
  ...
  },
  {
    ...
    info: 'Adds an inline master checkbox with a live checked/total counter on Profile, Permission Set, and other Setup edit tables. Works on direct classic pod pages and classic Setup iframes. Pure client-side DOM manipulation — no API calls.',
    defaultEnabled: false,
    accessLevel: 'ui-only',
  },
  {
  ...
  {
    id: 'console-formatter',
    name: 'Console Formatter',
    description: 'Readable snapshots for LWC/LWS console values',
    info: 'Preferred path: enable DevTools custom formatters so Salesforce can show proxy values natively. SF Boost adds an early snapshot fallback that logs plain expandable arrays/objects when native formatting is unavailable or insufficient, plus a window.SFBoostConsole helper namespace.',
    defaultEnabled: false,
    accessLevel: 'ui-only',
  },
];
